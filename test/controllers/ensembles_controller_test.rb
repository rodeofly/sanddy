...
class EnsemblesControllerTest < ActionController::TestCase
  ...
  test "should create ensemble" do
    assert_difference('Ensemble.count') do
      post :create, ensemble: { height: @ensemble.height, left: @ensemble.left, name: @ensemble.name, top: @ensemble.top, width: @ensemble.width }
    end
  ...
  test "should update ensemble" do
    patch :update, id: @ensemble, ensemble: { height: @ensemble.height, left: @ensemble.left, name: @ensemble.name, top: @ensemble.top, width: @ensemble.width }
    assert_redirected_to ensemble_path(assigns(:ensemble))
  end
