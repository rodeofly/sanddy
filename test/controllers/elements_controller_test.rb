...
class ElementsControllerTest < ActionController::TestCase
  ...
  test "should create element" do
    assert_difference('Element.count') do
      post :create, element: { height: @element.height, left: @element.left, name: @element.name, top: @element.top, width: @element.width }
    end
  ...
  test "should update element" do
    patch :update, id: @element, element: { height: @element.height, left: @element.left, name: @element.name, top: @element.top, width: @element.width }
    assert_redirected_to element_path(assigns(:element))
  end
